...
10. `cd /`
11. `cd tmp`
12. `mkdir randomkeyssh`
13. `nano ssh.key`
14. paste found ssh key 
15. `ssh -i ssh.key bandit17@localhost`
16. `chmod 400 ssh.key`
17. `ssh -i ssh.key bandit17@localhost`
18. `ls`
19. `cat passwords.new`
20. `cat passwords.old`
21. `cd /`
22. `cd etc`
23. `cat passwd`
24. `ls`
